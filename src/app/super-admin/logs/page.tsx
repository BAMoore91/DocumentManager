...
export default async function SuperAdminLogsPage({
  ...
  const [logs, total, orgs, actionGroups] = await Promise.all([
  ...
  function buildHref(overrides: Record<string, string | undefined>) {
    ...
    return s ? `/super-admin/logs?${s}` : "/super-admin/logs";
  }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-[hsl(var(--muted-foreground))]">
          Cross-organization audit trail for every recorded action on the platform.
        </p>
      </div>
      ...
      <Card>
        <form method="get" className="grid grid-cols-1 gap-3 md:grid-cols-5">
          <div>
            ...
            <Select id="org" name="org" defaultValue={orgFilter}>
